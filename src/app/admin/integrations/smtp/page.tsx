...
const TYPE: IntegrationType = "SMTP";
...
export default async function Page() {
  ...
  return (
    <div className="grid gap-5">
      <div><h1 className="text-xl font-bold tracking-tight">SMTP Email</h1><p className="text-sm text-[var(--muted)]">Configure + run a simulated connection test</p></div>
