...
const TYPE: IntegrationType = "Google Calendar";
...
export default async function Page() {
  ...
  return (
    <div className="grid gap-5">
      <div><h1 className="text-xl font-bold tracking-tight">Google Calendar</h1><p className="text-sm text-[var(--muted)]">Configure + run a simulated connection test</p></div>
